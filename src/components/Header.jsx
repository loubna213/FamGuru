      ...
      <div className="w-[95%] md:w-[90%] pl-4 pr-4 ml-auto mr-auto h-[95%] flex justify-between items-center">
        <div className='flex justify-between items-center w-full'>
          <Link to='/' className='flex justify-center items-center p-4'>
            <img className='logo-img' src={black_logo} alt="logo" />
          </Link>

          {/* Desktop Menu */}
          <nav className="hidden md:flex justify-center items-center">
            <NavLink to='/ourstory' className='p-6 hover:text-[#e91b63] transition-all duration-3000'>Our Story</NavLink>
            <NavLink to='/pricing' className='p-6 hover:text-[#e91b63] transition-all duration-3000'>Pricing</NavLink>
            <NavLink to='/contact' className='p-6 hover:text-[#e91b63] transition-all duration-3000'>Contact</NavLink>
          </nav>

          <Link className='bg-[#e91e63] hidden md:block text-white py-[10px] px-5 border-none rounded-3xl cursor-pointer text-[12px] hover:bg-[#d81b60]'>Download the App</Link>
